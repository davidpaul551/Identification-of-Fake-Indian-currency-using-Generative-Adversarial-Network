...
training_set = train_datagen.flow_from_directory(r'D:\CODE Fake Currency\training_set',
                                                 target_size=(64, 64),
                                                 batch_size=32,
                                                 class_mode='binary')

test_set = test_datagen.flow_from_directory(r'D:\CODE Fake Currency\test_set',
                                            target_size=(64, 64),
                                            batch_size=16,
                                            class_mode='binary')
